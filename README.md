...
This can be a useful tools if you quickly want to have an access token to test or use Zoho CRM APIs (using [Postman](https://www.getpostman.com/), for example)
